...
pub fn build_router(
    ...
    let (api_router, mut doc) = OpenApiRouter::new()
        ...
        .routes(routes!(crate::api::list_projects))
        .routes(routes!(crate::api::create_project))
        .routes(routes!(crate::api::remove_project))
        .routes(routes!(crate::api::project_tree))
        .routes(routes!(crate::api::project_excerpts))
        .routes(routes!(crate::api::read_project_file))
        .routes(routes!(crate::api::write_project_file))
        .routes(routes!(crate::api::create_project_file))
        .routes(routes!(crate::api::remove_project_file))
        .routes(routes!(crate::api::create_project_folder))
        .routes(routes!(crate::api::remove_project_folder))
        .routes(routes!(crate::api::rename_project))
        .routes(routes!(crate::api::rename_entry))
        .routes(routes!(crate::api::watch_project))
